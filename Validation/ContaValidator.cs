...
namespace contasAPagar.Validation
{
    public class ContaValidator : AbstractValidator<Model.ContaModel>
    {
        public ContaValidator()
        {
            ...
            .MaximumLength(100).WithMessage("O nome do credor dever ter no máximo 100 caracteres")
            .MinimumLength(3).WithMessage("O nome do credor deve ter no mínimo 3 caracteres");
